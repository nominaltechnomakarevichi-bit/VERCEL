        ...
        <section>
          <Card style={{ backgroundColor: "#0029FF" }} className="border-0">
            <CardContent className="space-y-4 text-white text-base md:text-lg pt-6">
              <p>
                <span className="font-semibold">Programmatic — это не альтернатива performance.</span> Это ин��трумент, который создает дополнительный спрос, усиливает работу performance-каналов и позволяет измерять бизнес-результат.
              </p>
            </CardContent>
          </Card>
        </section>
