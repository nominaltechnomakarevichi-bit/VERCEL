...
const technicalCapabilities = [
  ...
  {
    title: "Верхние позиции показа",
    description: "Возможность выбора верхних позиций показа креативов и закрепление рядом с контентом страницы: удержание Viewability 70%+",
    icon: TrendingUp,
  },
  {
    title: "Prebid-оптимизация",
    description: "Возможность установки prebid-оптимизации на уровне Viewability, VTR, CTR: исключение площадок с сомнительным контентом",
    icon: Target,
  },
]
...
export function FinanceGenericCaseSlide() {
...
export default FinanceGenericCaseSlide;
