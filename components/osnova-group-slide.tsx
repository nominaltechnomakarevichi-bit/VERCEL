...
// ОФД данные
const ofdData = [
  "Сегменты собираютя на основе данных об оплатах",
...
export function OsnovaGroupSlide() {
  ...
  const handleDownloadPNG = useCallback(async () => {
    ...
    try {
      ...
      link.href = dataUrl
      link.download = "osnova-group-presentation.png"
      link.click()
    } catch (error) {
          ...
          <div className="flex flex-col items-start gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div className="flex-1">
              <div className="flex items-center gap-4 mb-4">
                ...
                <a 
                  href="https://osnova.group/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:opacity-80 transition-opacity"
                >
                  <img 
                    src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/png-klev-club-eqq1-p-osnova-png-11-qT9JA4pGwfUF3voGKgIAHoPNP82Qz6.png"
                    alt="ГК ОСНОВА"
              ...
              <h1 className="text-4xl font-bold text-foreground">
                Предложение для Группы компаний «ОСНОВА»
              </h1>
            ...
            {audienceSegments.map((categoryData, idx) => (
              <div key={idx}>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-sm font-semibold text-muted-foreground">Емкость сегмента</span>
                </div>
                <div className="space-y-2">
                  {categoryData.segments.map((segment, segIdx) => (
                    ...
                    >
                      ...
                      <p className={segment.featured ? "font-bold text-primary" : "font-medium text-muted-foreground"}>
                        {segment.volume}
                      </p>
                    </div>
                  ))}
