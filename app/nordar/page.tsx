...
export default function NordarPage() {
  ...
  const richMediaFormats = [
    ...
    { id: 5, name: 'Scratch-баннер', description: 'Механика с эффектом проявления', videoUrl: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/%D0%97%D0%B0%D0%BF%D0%B8%D1%81%D1%8C%20%D1%8D%D0%BA%D1%80%D0%B0%D0%BD%D0%B0%202026-08-24%20%D0%B2%2016.11.50-FNyktfSnuJPiRHlfxOoIhEiG0gDl2t.mov', advantages: ['Создает интригу', 'Подходит для акций и промокодов'] },
