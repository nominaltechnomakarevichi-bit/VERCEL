...
export default function BkkKolomenskyPage() {
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="space-y-8">
            ...
            <div className="border-l-4 border-[#0029FF] pl-6">
              ...
              <p className="text-lg text-foreground mb-3">
                DOOH рекламу размещаем в магазинах Лента, Пятерочка и других торгов��х сетях, где пользователь принимает финальное решение о покупке. Outdoor реклама рядом с торговыми точками и на высокотрафиковых дорогах напоминает о бренде перед посещением магазина.
              </p>
            </div>
